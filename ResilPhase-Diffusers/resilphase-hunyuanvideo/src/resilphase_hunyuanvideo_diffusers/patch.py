...
def apply_resilphase(pipe_or_transformer, config: ResilPhaseHunyuanVideoConfig | None = None, **kwargs):
    ...
    if not isinstance(transformer, HunyuanVideoTransformer3DModel):
        raise TypeError("apply_resilphase expects a Diffusers HunyuanVideoPipeline or HunyuanVideoTransformer3DModel.")
