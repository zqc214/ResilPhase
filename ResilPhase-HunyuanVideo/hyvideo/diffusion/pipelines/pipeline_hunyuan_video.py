    ...
    def __call__(
        ...
        **kwargs,
        ...
        if cache_dic['test_FLOPs']:
            ...
            from ...modules.resilphase_utils import convert_flops
            total_flops = 0
        ...
        print(f"Diffusion sampling time: {sampling_time:.2f}s")
        ...
        return HunyuanVideoPipelineOutput(videos=image, sampling_time=sampling_time)
