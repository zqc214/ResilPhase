...
class HunyuanVideoSampler(Inference):
    ...
    def predict(
       ...
       embedded_guidance_scale: {embedded_guidance_scale}"""
        ...
        # Measure pure diffusion sampling time
        ...
        samples, sampling_time = pipeline_output
        out_dict["samples"] = samples
        out_dict["prompts"] = prompt
        out_dict["sampling_time"] = sampling_time  # Add diffusion timing

        gen_time = time.time() - start_time
        logger.info(f"Success, time: {gen_time}, diffusion_time: {diffusion_time:.4f}")
