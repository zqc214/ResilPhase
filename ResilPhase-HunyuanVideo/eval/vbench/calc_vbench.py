...
if __name__ == "__main__":
    args = parse_args()
    output_dir = os.path.join(args.save_path, "vbench")
...
python eval/vbench/calc_vbench.py \
    /root/autodl-tmp/HunyuanVideo_samples/VBench_Results/original/gen_videos \
    /root/autodl-tmp/HunyuanVideo_samples/VBench_Results/original
'''